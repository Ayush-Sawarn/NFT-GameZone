...
import {Alert,Card,GameInfo,PlayerInfo,ActionButton} from '../components'
...
const Battle=()=>{
    ...
    const {battleName}= useParams(); //useParams() is extracting the battleName directly from the browser's URL.
    ...
    },[contract,gameData,battleName]) // the useEffect() will work when changes occcur in them
    return (
                ...
                <div className={`${styles.flexCenter} flex-col my-10`}>
                    ...
                    <div className="flex items-center flex-row">
                        <ActionButton 
                            imgUrl={attack}
                            handleClick={()=>{}}
                            restTypes="mr-2 hover:border-yellow-400"
                        />
                        ...
                        <ActionButton 
                                imgUrl={defense}
                                handleClick={()=>{}}
                                restTypes="ml-6 hover:border-red-600"
                            />
